...
const Appointment = () => {
    ...
    const { doctors: barber, currencySymbol, backendUrl, token, getDoctosData } = useContext(AppContext)
    ...
    const fetchDocInfo = async () => {
        const docInfo = barber.find((doc) => doc._id === docId)
        setDocInfo(docInfo)
    }
    ...
    const bookAppointment = async () => {
        ...
        try {
            ...
            if (data.success) {
                ...
                console.log(docInfo.degree)
               
                const formattedData = {
                    name: docInfo.name, // Example name
                    email: docInfo.degree,
                    message: `
                      Appointment Booking.
                    `,
                  };
                    ...
                    const templateID = "template_00s921f";
